...
export VHD_URL="https://rhcos.blob.core.windows.net/imagebucket/rhcos-43.81.201912110942.0-azure.x86_64.vhd"
...
# az network dns zone create -g $RESOURCE_GROUP -n ${CLUSTER_NAME}.${BASE_DOMAIN} --resolution-vnets openshiftVnet --zone-type Private
